...
client.on("message", message => {
 if (message.content === `${prefix}`) {
  const embed = new Discord.RichEmbed() //by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
      ...
      .setDescription(`
F{prefix}play ⇏ لتشغيل أغنية برآبط أو بأسم
F{prefix}skip ⇏ لتجآوز الأغنية الحآلية
F{prefix}pause ⇏ إيقآف الأغنية مؤقتا
F{prefix}resume ⇏ لموآصلة الإغنية بعد إيقآفهآ مؤقتا
F{prefix}vol ⇏ لتغيير درجة الصوت 100 - 0
F{prefix}stop ⇏ لإخرآج البوت من الروم
F{prefix}np ⇏ لمعرفة الأغنية المشغلة حآليا
F{prefix}queue ⇏ لمعرفة قآئمة التشغيل
 `)//by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
